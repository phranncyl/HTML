...
<html lang="en">
	<head>
		...
		<!-- STEP 3: Make sure thazt you can browse to this page on the server - the URL that you would have to enter into the address bar in a browser might look something like https://mysitename.azurewebsites.net/week4/lab4/index.php (for Microsoft Azure) -->
	</head>
	<body>
		<!-- Page-level header -->
		<header>
		...
		<main>
			...
			<form action="subscribe.php" method="get">
				...
				<label required for="emailAddress"> Email</label>
				...
				<input type="text" name="emailAddress" id="emailAddress" placeholder="seunome@xxx.com"/>
